...
# INFORMAÇÕES GERAIS
# DT_GERACAO (DIA, MES, ANO), HH_GERACAO (HORA DA GERAÇÃO DOS DADOS), CD_TIPO_ELEICAO(1 SUPLEMENTAR, 2 ORDINARIA, 3 CONSULTA POP.), NR_TURNO, DT_ELEICAO, TP_ABRANGENCIA_ELEICAO (MUN., EST. FED.)
